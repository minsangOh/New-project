...
@Command(
        ...
        description = "Inspect a Phase 3A SQLite store and print table counts, quality status counts, and latest run summary."
)
public class InspectStoreCommand implements Callable<Integer> {
